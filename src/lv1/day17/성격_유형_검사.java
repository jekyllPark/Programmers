...
public class 성격_유형_검사 {
    ...
    public static String solution(String[] survey, int[] choices) {
        ...
        else if (map.get('R') == map.get('T')) sb.append('R');
        else sb.append('T');

        if (map.get('C') > map.get('F')) sb.append('C');
        else if (map.get('C') == map.get('F')) sb.append('C');
        else sb.append('F');

        if (map.get('J') > map.get('M')) sb.append('J');
        else if (map.get('J') == map.get('M')) sb.append('J');
        else sb.append('M');

        if (map.get('A') > map.get('N')) sb.append('A');
        else if (map.get('A') == map.get('N')) sb.append('A');
        else sb.append('N');
